            ...
            <div class="container">
                ...
                <div class="row position-relative d-flex justify-content-center">
                    <div class="position-relative col-12">
                        <img src="{{ (config('settings.dark_mode') == 1 ? asset('img/hero-dark.png') : asset('img/hero.png')) }}" class="img-fluid shadow-lg border-top-left-radius-2xl border-top-right-radius-2xl image-rendering-optimize-contrast" data-theme-dark="{{ asset('img/hero-dark.png') }}" data-theme-light="{{ asset('img/hero.png') }}" width="1512" height="700" data-theme-target="src" alt="{{ config('settings.title') }}">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 pt-4 mt-4">
                            <div class="d-flex flex-row">
                                <div class="d-flex width-12 height-12 position-relative align-items-center justify-content-center flex-shrink-0 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                    ...
                                    @include('icons.article', ['class' => 'fill-current width-6 height-6 text-primary'])
                                </div>
                        ...
                        <div>
                            <div class="row m-n4 position-relative">
                                <div class="col-3 p-4">
                                    ...
                                    <img src="{{ asset('img/media-1.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Matte painting') }}" alt={{ __('Matte painting') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-2.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Black & white portrait') }}" alt={{ __('Black & white portrait') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-3.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Computer motherboard') }}" alt={{ __('Computer motherboard') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-4.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Red flowers') }}" alt={{ __('Red flowers') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-5.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('City night lights') }}" alt={{ __('City night lights') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-6.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Honey bee') }}" alt={{ __('Honey bee') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-7.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Colorful umbrellas') }}" alt={{ __('Colorful umbrellas') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-8.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('White cat') }}" alt={{ __('White cat') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-9.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Brown cake') }}" alt={{ __('Brown cake') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-10.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Autumn leaves') }}" alt={{ __('Autumn leaves') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-11.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Green olives') }}" alt={{ __('Green olives') }} data-tooltip="true" loading="lazy">
                                </div>
                                <div class="col-3 p-4">
                                    <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-primary opacity-10 border-radius-2xl z-0 m-4" style="transform: translate(-1rem, 1rem);"></div>
                                    <img src="{{ asset('img/media-12.png') }}" width="256" height="256" class="img-fluid image-rendering-optimize-contrast position-relative border-radius-2xl shadow-lg z-1" title="{{ __('Blue car') }}" alt={{ __('Blue car') }} data-tooltip="true" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </div>
